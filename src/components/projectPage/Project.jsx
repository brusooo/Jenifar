...
const Project = () => {
  return (
    <section id="project" className="relative left-0 max-lg:top-24   w-screen min-h-screen flex flex-col justify-center items-center">
      ...
      <div className="relative w-[1200px] max-[640px]:translate-y-5 max-xl:scale-x-[.88] max-lg:flex-col max-lg:w-[500px] max-lg:gap-12   h-full gap-28 bg-lightWhite bg-opacity-30 rounded-3xl p-16 flex justify-center items-center">
